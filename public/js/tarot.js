...
mayores: [
  ...
  { n: 3,  nombre: "La Emperatriz",   palo: "",  emoji: "🌸", img: "/cartas/la-emperatriz.png", palabras: ["Abundancia", "Fertilidad", "Cuidado"],
    ...
    invertida: "Te estás descuidando. Dejas tu cuerpo, tu creatividad y tus sueños en el último lugar. Vuélvete tu primera prioridad: si tú no te nutres, nada florece." },
  ...
  { n: 6,  nombre: "Los Enamorados",  palo: "",  emoji: "💞", img: "/cartas/los-enamorados.png", palabras: ["Amor", "Unión", "Elección"],
    ...
    invertida: "La duda te está volviendo mitad. No elijas por miedo a estar solo y no te quedes donde apagan tu luz. Escucha tu verdad, aunque sea incómoda, y decide con valentía." },
  ...
  { n: 10, nombre: "La Rueda de la Fortuna", palo: "", emoji: "🎡", img: "/cartas/la-rueda-de-la-fortuna.png", palabras: ["Cambio", "Ciclos", "Destino"],
    ...
    invertida: "Te aferras a lo que ya se fue y frenas lo que llega. La rueda gira para todos, contigo o sin ti. Mejor girar con ella y no contra el suelo." },
  ...
  { n: 13, nombre: "La Muerte",       palo: "",  emoji: "🦋", img: "/cartas/la-muerte.png", palabras: ["Transformación", "Finales", "Renacimiento"],
    ...
    invertida: "No sueltas lo que ya murió y eso ocupa el lugar de lo nuevo. Mientras más abrazas el pasado, más le cuesta a tu vida florecer. Deja morir para poder renacer." },
  ...
  { n: 16, nombre: "La Torre",        palo: "",  emoji: "⚡", img: "/cartas/la-torre.png", palabras: ["Ruptura", "Revelación", "Cambio súbito"],
    ...
    invertida: "Sabes que algo se está cayendo y lo sostienes por miedo. Déjalo caer. Nada sólido se construye sobre mentiras. Abdala el golpe, recoge tus pedazos y vuelve a levantarte." },
  ...
  { n: 19, nombre: "El Sol",          palo: "",  emoji: "☀️", img: "/cartas/el-sol.png", palabras: ["Alegría", "Éxito", "Vitalidad"],
    ...
    invertida: "Tienes el sol y andas viendo nubes. Tu luz sigue ahí dentro, brillando. No la escondas por miedo ni por culpa: brilla, aunque otros quieran apagarte." },
